...
class Triangle extends Shape {
  ...
  renderText() {
    return `<text x="150" y="150" font-size="40" text-anchor="middle" fill="${this.textColor}">${this.userText}</text>`;
  }
...
class Square extends Shape {
  ...
  renderText() {
    return `<text x="125" y="130" font-size="40" text-anchor="middle" fill="${this.textColor}">${this.userText}</text>`;
  }
